...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="form" class="form-horizontal text-center" style="width:500px;margin: 20px auto 0;">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="desc" runat="server"  class="form-control"  placeholder="请输入作品简介" style="height: 200px;resize: none;" TextMode="MultiLine" ></asp:TextBox>
        </div>
        <div class="form-group">
            
            <asp:Button ID="submit" runat="server" Text="确&nbsp;认"  class="btn btn-primary" style="margin-right: 20px" OnClick="submit_Click" />
            <asp:Button ID="reset" runat="server" Text="重&nbsp;置" class="btn btn-danger" style="margin-left: 20px" />
